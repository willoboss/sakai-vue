              ...
              <div class="flex flex-wrap items-center gap-4">
                ...
                >
                  <div class="flex flex-col gap-4">
                    ...
                    <Message
                      v-if="$form.creditLimit?.invalid"
                      severity="error"
                      size="small"
                      variant="simple"
                      >{{ $form.creditLimit.error?.message }}</Message
                    >

                    <MultiSelect
                      name="servicesId"
                      :options="serviceMultiselect"
                    ...
                    />
                    <Message
                      v-if="$form.servicesId?.invalid"
                      severity="error"
                      size="small"
                      variant="simple"
                      >{{ $form.servicesId.error?.message }}</Message
                    >
                  </div>
                  <Button
                    type="submit"
...
const serviceMultiselect = ref([
  { label: "", code: "", description: "", selectLabel: "" },
]);
...
const onFormSubmitUpdate = (e) => {
  if (e.valid) {
    ...
    formulaUpdate.value.servicesId = e.values.servicesId.map(
...
function getService(serviceId) {
  return serviceStore.getServices.find(
