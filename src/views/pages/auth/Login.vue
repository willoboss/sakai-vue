                ...
                <form @submit.prevent="login">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to SmartBankAssist!</div>
                            <span class="text-muted-color font-medium">Sign in to continue</span>
                        </div>
    
                        <div>
                            <label for="login" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Login</label>
                            <InputText id="login" type="text" placeholder="username" class="w-full md:w-[30rem] mb-8" v-model="user.username" />
                            ...
                            <Button type="button" class="mr-2 mb-2" label="Sign in" :loading="loading[3]" @click="login(3)" />
                        </div>
                    </div> 
                </form>
            </div>
